...
interface LayoutProps {
  ...
  showCurrentPageInBreadcrumbs?: boolean;
}
...
const Layout = ({
  ...
  return (
    ...
    >
      ...
      <AutohidingNavbar allowHide={!showSettingsPanel} variant={variant}>
        <Container style={{ maxWidth: 'var(--navbar-width)', minHeight: NAVBAR_HEIGHT }}>
